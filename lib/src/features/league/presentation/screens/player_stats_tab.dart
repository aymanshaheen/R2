...
class TopPlayersWidget extends StatelessWidget {
  ...
  TopPlayersWidget({required this.title, required this.players, required this.statisticType});
          ...
          InkWell(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AllPlayersPage(players: players, title:title , statisticType: statisticType,),
                ),
              );
            },
            child: Row(
              ...
              return GestureDetector(
                onTap: () {
                  /*Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AllPlayersPage(players: players),
                    ),
                  );*/
                },
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          CircularImageBuilder(photo: players[index].photo, height: 30, width: 30),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          statisticType == 'goals'
                              ? players[index].statistics.goals.total.toString()
                              : statisticType == 'assists'
                                  ? players[index]
                                      .statistics
                                      .goals
