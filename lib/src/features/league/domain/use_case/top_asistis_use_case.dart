...
class TopAsisitisUseCase implements UseCase<List<PlayerTopScorers>, AsistsParams> {
  final LeagueRepository leagueRepository;

  TopAsisitisUseCase({required this.leagueRepository});

  @override
  Future<Either<Failure, List<PlayerTopScorers>>> call(AsistsParams league) async {
