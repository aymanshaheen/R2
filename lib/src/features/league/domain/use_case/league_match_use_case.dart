...
class LeagueMatchesUseCase extends UseCase<List<SoccerFixture>, LeagueMatchesParameter> {
  final LeagueRepositoryImpl leagueRepository;

  LeagueMatchesUseCase({required this.leagueRepository});

 @override
  Future<Either<Failure, List<SoccerFixture>>> call(LeagueMatchesParameter params) async {
