...
class TopScorersUseCase implements UseCase<List<PlayerTopScorers>, ScorersParams> {
  final LeagueRepository leagueRepository;

  TopScorersUseCase({required this.leagueRepository});

  @override
  Future<Either<Failure, List<PlayerTopScorers>>> call(ScorersParams league) async {
