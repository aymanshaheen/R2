...
class PlayerTopScorersModel extends PlayerTopScorers {
  ...
  PlayerTopScorersModel({required super.id, required super.name, required super.statistics, required super.photo});
  ...
  factory PlayerTopScorersModel.fromJson(Map<String, dynamic> json) {
    ...
    return PlayerTopScorersModel(
      ...
      statistics: StatisticsTopScorersModel.fromJson(json['statistics'][0]).toDomain(),
    );
  }
}
