...
class PlayerInfoCard extends StatelessWidget {
  ...
  PlayerInfoCard({required this.playerStatsInfo});

  @override
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: R.sW(context, 25), vertical: R.sH(context, 15)),
      child: Column(
        children: [
          PlayerInfoRow(
            context: context,
          ...
          PlayerInfoRow(
            context: context,
            value1: playerStatsInfo!.statisticsInfo[0].games.position.toString(),
            label1: 'Position',
