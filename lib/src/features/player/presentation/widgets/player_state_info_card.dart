...
class PlayerStatesInfoCard extends StatelessWidget {
  ...
  PlayerStatesInfoCard({required this.playerStatsInfo});

  @override
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: R.sW(context, 30), vertical: R.sH(context, 15)),
      child: Column( 
        children: [
          PlayerInfoRow(
            context: context,
            value1: playerStatsInfo!.statisticsInfo[0].games.appearences.toString(),
            label1: 'Matches',
          ...
          PlayerInfoRow(
            ...
            label2: 'Asists',
            value3: playerStatsInfo!.statisticsInfo[0].penalty.scored.toString(),
            label3: 'penalty',
          ),
        ],
      ),
