...
class LastMatchesUseCase extends UseCase<List<SoccerFixture>, LastMatchesParams> {
  final TeamRepository teamRepository;

  LastMatchesUseCase({required this.teamRepository});

 @override
  Future<Either<Failure, List<SoccerFixture>>> call(LastMatchesParams params) async {
...
class LastMatchesParams extends Equatable {
  ...
  const LastMatchesParams({required this.last,  this.teamId,required this.season});

  @override
  List<Object?> get props => [season, teamId,last];

  Map<String, dynamic> toJson() => {"season": season, "team": teamId,"last":last};
}
