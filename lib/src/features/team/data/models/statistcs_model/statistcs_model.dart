...
class TeamStatisticsModel extends TeamStatistics {
  ...
  factory TeamStatisticsModel.fromJson(Map<String, dynamic> json) {
    return TeamStatisticsModel(
      biggest:
          json["biggest"] == null ? null : BiggestModel.fromJson(json["biggest"]).toDomain(),
      ...
      fixtures:
          json["fixtures"] == null ? null : FixturesModel.fromJson(json["fixtures"]).toDomain(),
      form: json["form"] ?? '',
      goals: json["goals"] == null
          ? null
          : StatisticsModelGoalsModel.fromJson(json["goals"]).toDomain(),
      league: json["league"] == null ? null : LeaguesModel.fromJson(json["league"]).toDomain(),
      lineups: json["lineups"] == null
          ? []
      : List<Lineups>.from(json["lineups"]!.map((x) => LineupsModel.fromJson(x).toDomain())),
