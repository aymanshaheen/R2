...
class BiggestModel extends Biggest {
  ...
  factory BiggestModel.fromJson(Map<String, dynamic> json) {
    return BiggestModel(
      goals:
          json["goals"] == null ? null : BiggestGoalsModel.fromJson(json["goals"]).toDomain(),
      loses: json["loses"] == null ? null : LosesModel.fromJson(json["loses"]).toDomain(),
      streak: json["streak"] == null ? null : StreakModel.fromJson(json["streak"]).toDomain(),
      wins: json["wins"] == null ? null : WinModel.fromJson(json["wins"]).toDomain(),
    );
  }
}
...
class BiggestGoalsModel extends BiggestGoals {
  ...
  factory BiggestGoalsModel.fromJson(Map<String, dynamic> json) {
    return BiggestGoalsModel(
      ...
      goalsFor:
          json["for"] == null ? null : ForModel.fromJson(json["for"]).toDomain(),
    );
  }
}