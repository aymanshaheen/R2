...
import 'package:Goal/src/features/team/presentation/widgets/standings_container_over_view.dart';
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                widget.teamStatistics!.form == null || widget.lastMatches.isEmpty
                    ? Container()
