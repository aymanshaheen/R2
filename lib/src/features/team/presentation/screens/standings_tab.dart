                  ...
                  (index) => SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ...List.generate(widget.standings!.standings[index].length,
                            (teamIndex) {
                          TeamRank teamItem = widget.standings!.standings[index][teamIndex];
                          return StandingsItem(teamRank: teamItem,team: widget.team,);
                        }),
