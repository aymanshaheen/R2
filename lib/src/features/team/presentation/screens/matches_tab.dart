...
class MatchesTab extends StatefulWidget {
  ...
  MatchesTab({super.key, required this.nextMatches, required this.lastMatches});
...
class _MatchesTabState extends State<MatchesTab> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // Calculate the position of the last item of the first ViewDayFixtures
      // and the center of the second ViewDayFixtures
